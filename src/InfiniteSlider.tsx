...
const STDImage = styled.div<{ xPosition: number, width: number, height: number, transition: number }>`
  ...
  return (
    <STDContainer>
      <STDSliderContainer width={width} height={height}>
        <STDImageContainer>
          {images.map(el => <STDImage key={el.id} xPosition={xPosition} width={width} height={height} transition={transition}>
